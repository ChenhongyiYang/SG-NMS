...
class COCOeval:
    ...
    def __init__(self, cocoGt=None, cocoDt=None, iouType='segm', sub_type=0):
        '''
    ...
    def summarize(self,id_setup, res_file, _print):
        '''
    ...
    def plot(self,step,arr_mr,arr_fppi,arr_ms,iouThr=0.5, maxDets=1000):
